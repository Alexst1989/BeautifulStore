...
const baseUrl = 'https://www.alex.store.ru:8080/store';

export function httpPost(relativeUrl, requestData) {
    var localData;
    var instance = axios.create({
        timeout: 5000,
    });
    instance.post(baseUrl + relativeUrl, requestData).then((response) => {
        localData = response;
...
export function httpGet(relativeUrl, requestData) {
    var localData;
    var instance = axios.create({
        timeout: 5000,
    });
    instance.get(baseUrl + relativeUrl, requestData).then((response) => {
        localData = response;
        // console.log(response);
    }).catch((error) => {
        console.log(error);
